...
use windows::Win32::UI::Input::KeyboardAndMouse::{
    GetKeyState, GetKeyboardLayout, VIRTUAL_KEY, VK_0, VK_1, VK_2, VK_3, VK_4, VK_5, VK_6, VK_7,
    ...
    VK_RMENU, VK_RSHIFT, VK_RWIN, VK_S, VK_SCROLL, VK_SHIFT, VK_SNAPSHOT, VK_SPACE, VK_SUBTRACT,
    VK_T, VK_TAB, VK_U, VK_UP, VK_V, VK_VOLUME_DOWN, VK_VOLUME_MUTE, VK_VOLUME_UP, VK_W, VK_X,
    VK_Y, VK_Z, VkKeyScanExW,
};
...
impl KeyboardHook {
    ...
    fn handle_key_event(&self, vk_code: u16) -> bool {
        ...
        if let Some(keybindings) = keybindings {
            let mut cached_key_states = HashMap::default();
    ...
    fn match_keybindings(
        ...
        cached_key_states: &mut HashMap<u16, bool>,
